...
from . import command_account, command_market, command_strategy, command_system, command_trading  # noqa: F401, E402
...
def command_reply(text):
    ...
    return handler(command, argument) if handler else help_text()
