...
def is_supported_payload(payload):
    return isinstance(payload, dict) and (
        ...
        or payload.get("event_type") in ("TIMEFRAME_SNAPSHOT", "EA_ERROR", "EA_HEARTBEAT", "TRADE_CLOSE", "TRADE_OPEN", "BIG_MOVE", "TRADE_TRANSACTION", "ACCOUNT_RECONCILIATION", "ENTRY_DECISION", "ACCOUNT_ACTION_RESULT")
    )
